        ...
        <footer className="border-t">
            <div className="container py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="flex flex-col items-start gap-4">
                        <Link href="/" className="flex items-center space-x-2">
                            <Image src="/eshopiq-logo.svg" alt="eShopIQ logo" width={120} height={40} className="dark:invert"/>
                        </Link>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 col-span-3 gap-8 text-sm">
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><Link href="#" className="text-muted-foreground hover:text-foreground">Trending</Link></li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="mt-12 pt-8 border-t flex justify-between items-center text-sm text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} eShopIQ. All rights reserved.</p>
